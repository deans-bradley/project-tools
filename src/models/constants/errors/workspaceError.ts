import { BASE_ERROR_TYPE, ERROR_DOMAIN, createErrorCode, createErrorMessage } from './baseError';
...
export const WORKSPACE_ERROR = {
  ...
  EMPTY_PROFILE_NAME: createErrorCode(ERROR_DOMAIN.WORKSPACE, BASE_ERROR_TYPE.EMPTY_REQUIRED_FIELD)
} as const;
...
export const WORKSPACE_ERROR_MESSAGE = {
  ...
  [WORKSPACE_ERROR.EMPTY_PROFILE_NAME]: createErrorMessage(BASE_ERROR_TYPE.EMPTY_REQUIRED_FIELD, { field: "Profile name" })
} as const;

export type WorkspaceError = typeof WORKSPACE_ERROR[keyof typeof WORKSPACE_ERROR];
export type WorkspaceErrorMessage = typeof WORKSPACE_ERROR_MESSAGE[keyof typeof WORKSPACE_ERROR_MESSAGE];
