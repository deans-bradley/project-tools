...
export type ConfigError = typeof CONFIG_ERROR[keyof typeof CONFIG_ERROR];
export type ConfigErrorMessage = typeof CONFIG_ERROR_MESSAGE[keyof typeof CONFIG_ERROR_MESSAGE];
