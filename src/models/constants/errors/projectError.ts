 ...
 */
export const PROJECT_ERROR_MESSAGE = {
...
export type ProjectError = typeof PROJECT_ERROR[keyof typeof PROJECT_ERROR];
export type ProjectErrorMessage = typeof PROJECT_ERROR_MESSAGE[keyof typeof PROJECT_ERROR_MESSAGE];
